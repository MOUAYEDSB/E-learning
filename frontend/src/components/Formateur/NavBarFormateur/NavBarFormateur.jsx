import './navBarFormateur.css';
import { assets } from '../../../assets/assets';
import { useNavigate } from 'react-router-dom';
import { useEffect, useState } from 'react';

// eslint-disable-next-line react/prop-types
const NavbarFormateur = ({ setLogin }) => {
  ...
  return (
    <div className="navbar-formateur">
      <div className="navbar-formateur-search">
        <img src={assets.searchIcon} alt="Search Icon" />
        <form>
          <input type="text" placeholder='Rechercher ...' />
        </form>
      </div>
      <div className="navbar-formateur-right">
        <div className="navbar-formateur-right-icons">
          <img src={assets.calendarIcon} alt="Calendar Icon" />
          <img src={assets.notificationIcon} alt="Notification Icon" />
        </div>
        <div className="navbar-formateur-right-profile">
          <div className="profile-info">
            <h4>{userName}</h4>
            <p>Tunisia</p>
          </div>
          <div className='cell profileF'>
