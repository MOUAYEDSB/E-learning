...
const ListeFormateurs = () => {
  const [users, setUsers] = useState([
    { nom: 'Doe', prenom: 'John', email: 'john.doe@example.com', adresse: '123 Main St', telephone: '123-456-7890', ProfileImgURL: '', age: 30, titre: 'Mr', bio: 'Lorem ipsum dolor sit amet.' },
    { nom: 'Smith', prenom: 'Jane', email: 'jane.smith@example.com', adresse: '456 Oak St', telephone: '987-654-3210', ProfileImgURL: '', age: 28, titre: 'Mrs', bio: 'Consectetur adipiscing elit.' },
  ...
  const filteredUsers = users.filter(user =>
    ...
    user.titre.toLowerCase().includes(searchTerm.toLowerCase())
  );
